...
*Focused on performance-critical systems, memory efficiency, and data-driven software.*
...
## 🚀 Impact Highlights
* **Performance:** Achieved a ~105% increase in engine throughput (NPS) through SIMD-accelerated NNUE inference compared to baseline evaluation
...
* **Pasture Biomass Prediction:** Leveraged **Vision Transformers (DINOv2)** and multitask learning with multiple regression heads to predict biomass components.
* **Automated ML Pipelines:** Integrated ensemble prediction and test time augmentation (TTA), improving model accuracy by approximately **11%**.
...
* **Developer Tools:** Git, GitHub, CI/CD, Docker, CMake, Valgrind, Google Cloud Platform.
